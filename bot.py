...
def main():
    ...
    if not db.get_all_plans():
        ...
        db.add_plan('3GB',   597000, '3 GB',  90)
        db.add_plan('5GB',  995000, '5 GB',  90)
        db.add_plan('10GB', 1990000, '10 GB', 90)
        db.add_plan('15GB', 2985000, '15 GB', 90)
        db.add_plan('20GB', 3980000, '20 GB', 90)
